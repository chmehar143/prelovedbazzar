    ...
    public function index($id)
    {
        ...
        if($product)
        {
            ...
            return view('user.product-details', compact('product','vendor',
                        'category','subcategory','childcategory','moreproducts', 
                        'related_products','five', 'four', 'three', 'two', 'one', 
                        'allreview', 'helppositive', 'helpnegative', 'highrate', 'lowrate'));

        }
        else
        {
            return redirect()->back()->with('message', "product doesn't exist! ");
        }
    }
